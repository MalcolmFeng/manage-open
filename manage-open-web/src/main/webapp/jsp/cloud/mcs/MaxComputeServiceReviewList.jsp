...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<l:asset path='cloud/mcs/maxComputeServiceReviewList.css'/>"/>
    <title>大数据计算服务实例审核列表</title>
</head>
...
<div class="content">
    ...
    <div id="search" class="col-xs-12 col-md-12 header">
        <div class="row">
    ...
    <table id="instanceList" class="table table-bordered table-hover">
        <thead>
        <tr>
            <th width="5%" data-field="instance_id" data-sortable="false" data-render="renderCheckbox">
                <input type="checkbox" id="selectAll" onclick="forSelectAll()">
            </th>
            <th width="20%" data-field="instance_name" data-sortable="false">
                实例名称/ID
            </th>
            <th width="10%" data-field="service_version" data-sortable="false">产品版本</th>
            <th width="15%" data-field="specification" data-sortable="false" data-render="renderSpecification">
                服务规格
            </th>
            <th width="12%" data-field="status" data-sortable="false" data-render="renderStatus">状态</th>
            <th width="13%" data-field="apply_user" data-sortable="false">申请人</th>
...
<script type="text/javascript" src="<l:asset path='cloud/mcs/maxComputeServiceReviewList.js'/>"></script>
