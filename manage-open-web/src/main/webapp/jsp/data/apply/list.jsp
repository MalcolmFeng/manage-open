...
<script type="text/javascript">
  ...
  /*  grid.setParameter("tableName", tableName);
    grid.setParameter("authStatus", authStatus);
    reloadMyApplyList();*/
  }
  ...
  function renderOptions(data, type, full) {
    var html = "<div>";
    if(full.authStatus == '0'||full.authStatus == '2') {
		...
		<div class="row">
			<form class="form-inline" onsubmit="return false;">
				<div class="input-group">
			        <input class="form-control ue-form" type="text" id="tableName" placeholder="请输入数据名称"/>
			...
			<table id="myApplyList" class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th width="20%" data-field="name">数据名称</th>
						<th width="20%" data-field="tableName">表名称</th>
						<th width="15%" data-field="description">数据描述</th>
						<th width="20%" data-field="applyTime">申请时间</th>
						<th width="15%" data-field="authStatus" data-render="renderAuthStatus">授权状态</th>
