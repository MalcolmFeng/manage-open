...
<script type="text/javascript">
   ...
   var seq = '${seq }';
	...
	function save(){
	    $.ajax({
	      type: "post",
	      url: context + "/service/data/group/save",
	      data: $("form").serialize(),
				...
				<div class="form-group">
					...
					<div class="col-xs-9 col-md-9">
						<input type="text" class="form-control ue-form Validform_input" name="name"
							placeholder="数据分组名称" datatype="gname" errormsg="请输入字母、数字、汉字或下划线"
							nullmsg="请填写数据分组名称" />
				...
				<div class="form-group">
					...
					<div class="col-xs-9 col-md-9">
					    <input type="text" class="form-control ue-form Validform_input" name="seq"
							 errormsg="显示顺序必须为数字(0-99)" datatype="n1-2" nullmsg="显示顺序" value="${seq }">
						<span class="Validform_checktip Validform_span"></span>
					</div>
				</div>
