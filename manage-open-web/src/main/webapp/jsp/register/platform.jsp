...
<div class="">
    <div class="row" style="padding: 0 20vw;display: flex;align-items: center;margin: 15px 0;">
        ...
        <span style="margin-left: 15px;font-weight: bold;">完善机构信息</span>
    </div>
    <!-- 验证信息wrap -->
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group form-inline">
            <label class="col-xs-3 col-md-3 control-label">机构执业许可证登记号<span class="required">*</span></label>
            <div class="col-xs-8 col-md-8">
                <input type="text" class="form-control ue-form Validform_input" id="licence" value="" placeholder="系统带出前18位" disabled="disabled" datatype="s5-16" errormsg="昵称至少5个字符,最多16个字符！" nullmsg="请设置正确名称" style="margin-right: 1vw;">
                <input type="text" class="form-control ue-form Validform_input" id="last-num" value="" placeholder="用户补齐后4位" datatype="s5-16" errormsg="昵称至少5个字符,最多16个字符！" nullmsg="请设置正确名称">
                <span class="Validform_checktip Validform_span"></span>
            </div>
        </div>
        <div class="form-group form-inline">
            <label class="col-xs-3 col-md-3 control-label">所在地区<span class="required">*</span></label>
            <div class="col-xs-8 col-md-8">
