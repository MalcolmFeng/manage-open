...
<div>
    ...
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8 col-md-8">
                <select class="form-control ue-form" style="width: 60%">
        ...
        <div class="row" style="    padding: 0 20vw;display: flex;align-items: center;margin: 25px 0 15px 0;padding-top: 15px;border-top: 1px solid #cccccc;">
            <img style="width: 1.5vw" src="/skins/skin/img/account.png" />
            <span style="margin-left: 15px;font-weight: bold;">填写对公账号资料</span>
        </div>
        <div class="form-group">
            <label class="col-xs-3 col-md-3 control-label">对公账号开户行<span class="required">*</span></label>
            <div class="col-xs-8 col-md-8">
                <input type="text" class="form-control ue-form Validform_input" id="account-bank" value="" placeholder="机构联系人" datatype="s5-16" errormsg="昵称至少5个字符,最多16个字符！" nullmsg="请设置正确名称">
                <span class="Validform_checktip Validform_span"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-3 col-md-3 control-label">对公账号<span class="required">*</span></label>
            <div class="col-xs-8 col-md-8">
                <input type="text" class="form-control ue-form Validform_input" id="account" value="" placeholder="机构联系人电话" datatype="s5-16" errormsg="昵称至少5个字符,最多16个字符！" nullmsg="请设置正确名称">
                <span class="Validform_checktip Validform_span"></span>
            </div>
        </div>
        <div class="form-group">
