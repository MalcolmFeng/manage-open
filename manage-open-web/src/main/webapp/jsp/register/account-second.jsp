    ...
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-xs-8 col-md-8">
                ...
                <input type="text" class="form-control ue-form Validform_input" id="last-num" value="" placeholder="用户补齐后4位" disabled="disabled" datatype="s5-16" errormsg="昵称至少5个字符,最多16个字符！" nullmsg="请设置正确名称">
                <span class="Validform_checktip Validform_span"></span>
            </div>
        </div>
        <div class="form-group form-inline">
