...
<head>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            grid.setParameter("auditStatus", "0");
        ...
        function apiauth(openServiceId) {
            ...
            $.dialog({
                type: "iframe",
                title: "应用列表",
                url: context + '/jsp/service/applist/auth_list.jsp?openServiceId=' + openServiceId+"&applyFlag="+apply_Flag,
                width: 700,
                height: 400
            });
        }
        ...
        function forRegister() {
            window.location.href = context + "/service/open/api/release";
		...
		<form class="form-inline" onsubmit="return false;">
			...
			<div class="btn-group pull-right">
				<button id="add" type="button" class="btn ue-btn" onclick="forRegister()">
					<span class="fa fa-plus"></span>API发布
				</button>
			</div>
		</form>
	</div>
