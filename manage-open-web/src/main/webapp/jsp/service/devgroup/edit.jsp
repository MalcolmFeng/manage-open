...
<script type="text/javascript">
   ...
   //上下文的校验
   function gcontext(gets,obj,curform,datatype) {
       if(gets==""){
           $("#context").val("${group.context}");
           <%--$("#context").val("${group.context}");--%>
           return true;
       }else if (gets.length > 32) {
           obj.attr("errormsg", "不能超过32个字符");
           return false;
       } else {
           var regx = /^[a-zA-Z0-9]+$/;
	...
	<div class="container" id="sandbox-container">
	  <div class="col-xs-12 col-md-12">
			<form class="form-horizontal" id="saveForm" name="saveForm" onsubmit="return false">
				...
				<div class="form-group">
					...
					<div class="col-xs-9 col-md-9">
						<input type="text" class="form-control ue-form Validform_input"
							id="groupName" name="name" value="${group.name}" placeholder="api分组名称"
				...
				<div class="form-group">
					<label class="col-xs-3 col-md-3 control-label">
						上下文<%--<span class="required">*</span>--%>
					</label>
					<div class="col-xs-9 col-md-9">
						<input type="text" class="form-control ue-form Validform_input"
							   id="context" name="context" value="${group.context}" placeholder="上下文"
							   datatype="gcontext" errormsg="请输入字母、数字"  />
						<span class="Validform_checktip Validform_span"></span>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<textarea id="description" name="description" rows="3" cols="80" style="width:80%;"
							  ...
							  overflow="auto" dataType="verifyDescritpion" errormsg="描述字数限制在5-200个!" nullmsg="请填写描述">${group.description }</textarea>
						<span class="Validform_checktip Validform_span"></span>
					</div>
				</div>
