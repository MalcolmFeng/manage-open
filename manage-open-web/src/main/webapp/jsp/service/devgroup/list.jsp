    ...
    <div class="row">
        <table id="groupList" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <th width="25%" data-field="context">上下文</th>
                <th width="25%" data-field="name">分组名称</th>
                <th width="25%" data-field="description">描述</th>
                <th width="20%" data-field="id" data-render="renderoptions">操作</th>
            </tr>
            </thead>
        </table>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = context + "/service/dev/group/list/";
        ...
        $("#back").bind("click", function () {
            window.location.href = context + "/jsp/service/devgroup/list.jsp";
        });
    });
    ...
    function del(groupId) {
        $.dialog({
            ...
            ok: function () {
                $.ajax({
                    url: context + "/service/dev/group/delete/" + groupId,
    ...
    function add() {
        $.dialog({
            type: "iframe",
            title: "添加api分组",
            url: context + '/jsp/service/devgroup/add.jsp',
            width: 450,
            height: 250,
            onclose: function () {
                reloadGroupList();
    ...
    function modify(groupId) {
        if (typeof(groupId) != 'undefined') {
            $.dialog({
                type: "iframe",
                title: "编辑api分组",
                url: context + '/service/dev/group/edit/' + groupId,
                width: 420,
                height: 300,
                onclose: function () {
                    reloadGroupList();
